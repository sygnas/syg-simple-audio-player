...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__dist_simple_audio_player_es__ = __webpack_require__(1);



var audio_player = new __WEBPACK_IMPORTED_MODULE_0__dist_simple_audio_player_es__["a" /* default */]('.js-audio');
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__sygnas_audio_src__ = __webpack_require__(2);
...
var _class = function () {
  ...
  function _class(target, audio, config) {
    ...
    // オーディオソース
    this.audio_src = new __WEBPACK_IMPORTED_MODULE_0__sygnas_audio_src__["a" /* default */]({
      hds: this.opt.hds,
      hls: this.opt.hls,
      mse: this.opt.mse
    });
...
//# sourceMappingURL=simple-audio-player.es.js.map
